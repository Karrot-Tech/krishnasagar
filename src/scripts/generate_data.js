// src/scripts/generate_data.js

/**
 * Script to read raw YouTube transcript data, classify entries, and generate structured data
 * for chapters, leela_articles, bodhakatha_articles, and glossary according to the web schemas.
 *
 * It uses simple keyword-based classification and calls a language model (e.g., OpenAI) to
 * generate enriched fields such as Hindi/English titles, descriptions, keywords, and social tags.
 *
 * The script writes the consolidated result to `generated_data.json` at the project root.
 */
...
// ==== Configuration ==== //
const RAW_DATA_PATH = path.resolve(__dirname, '../../data/raw-upstream-data/yt-transcripts-data.json');
